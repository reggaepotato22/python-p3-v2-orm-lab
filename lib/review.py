...
class Review:
    ...
    def employee_id(self, employee_id):
        if isinstance(employee_id, int) and Employee.find_by_id(employee_id):
            ...
            raise ValueError("employee_id must be an integer and correspond to an existing Employee.")
    ...
    def update(self):
        if self.id is None:
            raise ValueError("Cannot update a review that has not been saved to the database.")
